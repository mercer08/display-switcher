...
enum Localization {
    ...
    private static let english: [CopyKey: String] = [
        ...
        .applying: "Applying",
        .displays: "Displays",
        .noDisplaysTitle: "No displays from BetterDisplay yet",
        .noDisplaysSubtitle: "Refresh after BetterDisplay and CLI integration are enabled.",
        .sources: "sources",
        .product: "Product",
        ...
        .setupCheckDisplays: "Connected Displays",
        .setupCheckDisplaysMissing: "No displays were returned by BetterDisplay CLI.",
        ...
        .noBetterDisplayDisplays: "No BetterDisplay displays found",
        .foundDisplays: "Found",
    ...
    private static let chinese: [CopyKey: String] = [
        ...
        .applying: "应用中",
        .displays: "显示器",
        .noDisplaysTitle: "还没有 BetterDisplay 显示器",
        .noDisplaysSubtitle: "启用 BetterDisplay 集成功能后刷新。",
        .sources: "个输入源",
        .product: "产品",
        .vendorModel: "厂商 / 型号",
        .made: "制造时间",
        ...
        .noBetterDisplayDisplays: "未找到 BetterDisplay 显示器",
        .foundDisplays: "已找到",
        .refreshFailed: "刷新失败",
        .newGroup: "新策略组",
